        ...
        <div className={css.secondLayerContainer}>
          ...
          >
            <p className={css.historyCreationText}>
              ...
              архітектор В. В. Жихарєв. Проект посадок на решті території
              виконала дендролог Я. Я. Яценко за порадами заввідділу дендрології
              Ботанічного саду АН УРСР професора Л. І. Рубцова. <br />
              Дендропарки України «Тростянець», «Софіївка», «Олександрія»
              надсилали посадковий матеріал, на базі якого і було створено
              колекцію порід дерев та кущів — понад 200 видів. <br />З 1977 року
              згідно з постановою Держкомприроди УРСР його оголошують заповідним
              зі статусом парку-пам'ятки садово-паркового мистецтва
              республіканського значення. У 1987 році відбувся Всесоюзний
              конкурс парків, де Полтавський міський парк (дендропарк) посів
              друге місце після Ізмайлівського парку міста Москви. У 1990 році
              парк отримує статус парку-пам'ятки садово-паркового мистецтва
