export const ua = {
  translation: {
    ...
    about: {
      ...
      descriptionThirdParagraph: "Парк багатий джерелами, по усіх балках течуть рукава річечки під назвою Тарновщанська Тарапунька, яка впадає у Ворсклу поблизу сел. Вороніна. Розкішний килим різнотрав'я в поєднанні з водою, заростями очерету, деревами різної форми і кольору, створюють незабутній ефект.",
